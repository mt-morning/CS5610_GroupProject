...
const ProductFilter = /* #__PURE__ */(function (_React$Component) {
  _inherits(ProductFilter, _React$Component);

  const _super = _createSuper(ProductFilter);
...
const InventoryRead = /* #__PURE__ */(function (_React$Component2) {
  _inherits(InventoryRead, _React$Component2);

  const _super2 = _createSuper(InventoryRead);
...
function InventoryTable(_ref2) {
  const { inventory } = _ref2;
  const inventoryRows = inventory.map(product =>
  /* #__PURE__ */React.createElement(InventoryRow, {
      key: product.id,
      product,
    }));
...
const InventoryList = /* #__PURE__ */(function (_React$Component4) {
  _inherits(InventoryList, _React$Component4);

  const _super4 = _createSuper(InventoryList);
  ...
  _createClass(InventoryList, [{
    ...
    key: 'addProduct',
    value: (function () {
      const _addProduct = _asyncToGenerator(/* #__PURE__ */regeneratorRuntime.mark(function _callee2(product) {
        let query; let
          data;
...
const element = /* #__PURE__ */React.createElement(InventoryList, null);
